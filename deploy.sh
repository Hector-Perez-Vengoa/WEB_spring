...
# Script de deploy para Exam_Perez
# Este script construye la imagen Docker y ejecuta el contenedor

echo "🚀 Iniciando deploy de Exam_Perez..."

# Detener y eliminar contenedor existente si existe
echo "🛑 Deteniendo contenedor existente..."
docker stop exam-perez 2>/dev/null || true
docker rm exam-perez 2>/dev/null || true
